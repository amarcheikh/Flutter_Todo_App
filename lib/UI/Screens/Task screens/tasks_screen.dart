...
import '../../../Core/enums/task_sorting.dart';
                  ...
                  DropdownButton<TaskFilter>(
                    ...
                    onChanged: (TaskFilter? newValue) {
                      if (newValue != null) {
                        ...
                        taskProvider.updateSortOption(TaskSortOption.aucun);
                      }
                    },
                  ...
                  DropdownButton<TaskSortOption>(
                    ...
                    onChanged: (TaskSortOption? newValue) {
                      if (newValue != null) {
                        ...
                        taskProvider.updateFilter(TaskFilter.tout);
                      }
                    },
                    items: TaskSortOption.values.map((TaskSortOption filter) {
                      String optionText = '';
                      if (filter == TaskSortOption.aucun) {
                        optionText = 'Aucun';
                      } else if (filter == TaskSortOption.datefin) {
                        optionText = 'Date de fin';
                      } else if (filter == TaskSortOption.datedebut) {
                        optionText = 'Date de debut';
                      }
                            ...
                            child: TaskBlock(
                              ...
                              onDone: () {
                                taskProvider.updateTaskStatus(
                                    task.id, !task.termine);
                              },
                              dueDate: task.datefin,
                              createDate: task.datedebut,
                            ),
                          );
                        },
                      );
